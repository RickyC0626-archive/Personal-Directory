...
public class Advisor extends Person
{
	...
	public void advisorMenu() throws InterruptedException, Exception
	{
		...
		try
		{
			...
			System.out.println("[3] Message User");
			...
			switch(selection)
			{
				...
				case "3": format.loading(); messageUser(); break;
				case "4": format.loading(); quit(); break;
